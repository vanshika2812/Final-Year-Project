              ...
              Center(
                child: Wrap(
                  ...
                  children: [
                    ...
                    _buildCard(
                      'https://files.porsche.com/filestore/news/international-de/none/347801/headimage1/8a1acca9-3b39-11e5-8c35-0019999cd470/Porsche-celebrates-30-years-of-the-959-at-the-Oldtimer-Grand-Prix-2015.jpg',
...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: AppBar(
        backgroundColor: Color.fromARGB(255, 200, 244, 230),
        elevation: 0,
        title: Text(
          'AR CAR SHOWROOM',
          style: TextStyle(
